     ...
     */
     add(nameOfEvent) {
        ...
        if (typeof this.cacheList[nameOfEvent] === 'string') {
            if (typeof this.cache[nameOfEvent] === 'undefined') {
                this.cacheSelected.set(nameOfEvent, this.cacheList[nameOfEvent]) 
                this.cache.set(this.cacheList[nameOfEvent], nameOfEvent) 
            }
        }   
    }
