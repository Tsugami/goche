...
module.exports = {
    204: {
        description: 'The request completed successfully but returned no content.'
    },
    304: {
        description: 'The entity was not modified (no action was taken).'
    },
    400: {
        description: 'The request was improperly formatted, or the server couldn\'t understand it.'
    },
    401: {
